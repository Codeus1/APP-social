  ...
  return (
    <Pressable onPress={onPress} style={styles.container}>
      ...
      <View style={styles.thumbnailWrapper}>
        <Image source={{ uri: plan.imageUrl }} style={styles.thumbnail} />
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle} numberOfLines={1}>
          {plan.location} • {plan.distance}
        </Text>
        <View style={styles.tagsRow}>
          <View style={[styles.priceChip, isCheap && styles.priceChipCheap]}>
            <Text style={[styles.priceChipText, { color: priceColor }]}>
              {formatPrice(plan.price)}
            </Text>
          </View>
          <Text style={styles.energyText}>{formatEnergy(plan.energy)}</Text>
        </View>
      </View>
