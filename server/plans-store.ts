...
function loadPlansFromDisk(): Plan[] {
  try {
...
function savePlansToDisk(currentPlans: Plan[]) {
  ensureDataDir();
  writeFileSync(DATA_FILE, JSON.stringify(currentPlans, null, 2), 'utf-8');
}

const plans: Plan[] = loadPlansFromDisk();
