        ...
        >
            <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-red-900">
                    {errorEntries.length}{' '}
                    {errorEntries.length === 1 ? 'Error' : 'Errors'} Found
                </h3>
            </div>
...
function ErrorToast({
    ...
    return (
        <div className="fixed bottom-4 right-4 bg-red-600 text-white px-6 py-4 rounded-lg boxShadow-lg flex items-start gap-3 max-w-sm animate-slide-in">
            <svg
