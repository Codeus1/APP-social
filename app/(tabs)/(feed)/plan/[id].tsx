        ...
        <SafeAreaView style={styles.safeArea} edges={['left', 'right']}>
                    ...
                    <View style={styles.hostCard}>
                        <View style={styles.hostLeft}>
                            <View style={styles.hostAvatarWrapper}>
                                <Image
                                    source={{ uri: plan.host.avatarUrl }}
                            ...
                            <View>
                                ...
                                <Text
                                    style={styles.hostTrust}
                                >{`Trust score: ${plan.matchPercentage}%`}</Text>
                            </View>
                        </View>
            ...
            <View style={styles.bottomBar}>
                <Pressable
                    style={[
                        styles.joinCta,
                        (isFull || joinPlanMutation.isPending) && {
                            opacity: 0.6,
                        },
                    ]}
                    onPress={handleJoin}
                    disabled={isFull || joinPlanMutation.isPending}
                >
